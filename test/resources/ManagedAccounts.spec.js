...
describe('Managed Accounts', function () {
  ...
  describe('retrieveManagedAccount', function () {
    ...
    it('Sends the correct request', function () {
      return telnyx.managedAccounts
        .retrieveManagedAccount({id: 'f65ceda4-6522-4ad6-aede-98de83385123'})
        .then(responseFn);
    });
  ...
  describe('updateManagedAccount', function () {
    ...
    it('Sends the correct request', function () {
      return telnyx.managedAccounts
        .updateManagedAccount({id: 'f65ceda4-6522-4ad6-aede-98de83385123'})
        .then(responseFn);
    });
  ...
  describe('disableAccount', function () {
    ...
    it('Sends the correct request', function () {
      return telnyx.managedAccounts
        .disableAccount({id: 'f65ceda4-6522-4ad6-aede-98de83385123'})
        .then(responseFn);
    });
  ...
  describe('enableAccount', function () {
    ...
    it('Sends the correct request', function () {
      return telnyx.managedAccounts
        .enableAccount({id: 'f65ceda4-6522-4ad6-aede-98de83385123'})
        .then(responseFn);
    });
